 ...
 */
final class Version20240918141717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, release_date DATE DEFAULT NULL, director VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, media VARCHAR(255) DEFAULT NULL, entries INT DEFAULT NULL, rating DOUBLE PRECISION DEFAULT NULL, duration INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
